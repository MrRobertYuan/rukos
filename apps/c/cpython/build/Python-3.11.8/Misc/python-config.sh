...
prefix="/media/robert/data/ruxos-0510/rukos/apps/c/cpython/../dl/rootfs"
exec_prefix="${prefix}"
exec_prefix_real=${prefix_real}
includedir=$(echo "${prefix}/include" | sed "s#$prefix#$prefix_real#")
libdir=$(echo "${exec_prefix}/lib" | sed "s#$prefix#$prefix_real#")
CFLAGS=$(echo " -I/media/robert/data/ruxos-0510/rukos/apps/c/cpython/../dl/rootfs/include/" | sed "s#$prefix#$prefix_real#")
VERSION="3.11"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
